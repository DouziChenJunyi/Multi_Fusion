      ...
      <el-container class="el_container">
        ...
        <el-container style="margin-top: -2%;">
              ...
              <div id="aside-left-top" height="41.2%" width="80%">
                <div id="nav-line">
                  <div id="nav_image">
                    ...
                    <img src="../assets/multimodel_highlight.png" width="28%" @click="nav_multimodel">
                    <img src="../assets/multiview.png" width="28%" @click="nav_multiview">
                  </div>
                </div>
                <div id="nav-info">
                  <div id="info-box-head" width="100%" height="100%">
          ...
          <el-container width="100%">
            <el-aside style="width: 39%; overflow: hidden;">
              ...
              <div>
                <div style="display: none;">
                  <div style="display: none;">
                    <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <input id="select_Text_Input" type="file" size="30" name="text" @change="selectText(getTextContent)">
                ...
                <div style="display: flex; justify-content: space-around; margin-top: 2%;">
                  <div id="btn_wrapper" style="border: none;">
                    <el-button id="select_Img_btn" type="primary" plain size="mini" @click="click_to_selectImg">传入图像模态</el-button>
                  </div>
                  <div id="btn_wrapper" style="border: none;">
                    <el-button id="select_Text_btn" type="primary" plain size="mini" @click="click_to_selectText">传入文本模态</el-button>
                  </div>
                </div>
                ...
                <div id="carousel">
                  <template>
                    <div id="banner">
                      ...
                      <el-carousel :height="bannerHeight2 + 'px'" :loop="true" :autoplay="true" trigger="click" indicator-position="none">
                        <!--遍历图片地址,动态生成轮播图-->
              ...
              <div id="btn_layer">
                <div style="display: flex; justify-content: space-around; margin-top: 2%;">
                  <div id="btn_wrapper">
                    <el-button id="Img_btn" plain size="mini" @click="ImgRegc">图像识别</el-button>
                  </div>
                  <div id="btn_wrapper">
                ...
                <div id="" style="height: 80%;">
                  ...
                  <div v-if="loading_flag" style=" width:100%; height: 2rem;  background-color: black; margin-top: -30%;">
            ...
            <el-main>
              <div id="main">
                ...
                <div style="margin: -10% 0 0 5%;">
                  <div id="timecnt" style="margin-top: 9.5%; display: flex;">
...
export default {
  data() {
    return {
      cost_time: [0, 0, 0, 0, 0],
      loading_flag: false,
      text_content: '尚无传入文本，请点击"传入文本模态"按钮进行选择',
      text_title: '',
      request_form: '',
      activated_tableData: [{
        activated: '已启动',
      ...
      get_img_list: [
        require('../assets/no_imageTextFusion_res.png')
      ],
      // 图片父容器高度
      bannerHeight: 1000,
      bannerHeight2: 150,
  ...
  methods: {
    ...
    click_to_selectImg() {
      document.getElementById('select_Img_Input').click()
      document.getElementById('select_Img_btn').blur()
    },
    click_to_selectText() {
      document.getElementById('select_Text_Input').click()
      document.getElementById('select_Text_btn').blur()
    },
    selectImg(e) {
      const that = this
      ...
      document.getElementById('select_Img_btn').style = 'background-color: #f0f9eb; color: #67C23A; border-color: #c2e7b0;'
    },
    selectText(callback) {
    ...
    ImgRegc() {
      if (this.request_form.has('mode')) {
        // 对接时改为mode = 4
        this.request_form.set('mode', 4)
      } else {
        this.request_form.append('mode', 4)
      }
      document.getElementById('Img_btn').blur()
    ...
    FusionRegc() {
      if (this.request_form.has('mode')) {
        // 对接时改为mode = 5
        this.request_form.set('mode', 5)
      } else {
        this.request_form.append('mode', 5)
      }
      document.getElementById('Fusion_btn').blur()
      if (this.request_form.has('photo_UAV')) {
        if (this.request_form.has('infos')) {
          this.send_request()
        }
      }
    },
    async send_request(mode) {
      try {
